      ...
      >
        ...
        <div className="rounded-xl border border-slate-800 bg-slate-950/50 p-4">
          ...
          <button
            ...
            disabled={screen.loading || screen.guestLoading}
            className="mt-3 w-full rounded-lg border border-slate-700 py-2.5 text-sm font-medium text-slate-200 hover:border-slate-600 hover:bg-slate-900 disabled:opacity-50"
          >
