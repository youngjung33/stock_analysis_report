...
export const AppErrorCode = {
  ...
  TRANSACTION_COMMISSION_INVALID: 'TRANSACTION_COMMISSION_INVALID',

  AUTH_OAUTH_REDIRECT_URI_REQUIRED: 'AUTH_OAUTH_REDIRECT_URI_REQUIRED',
  AUTH_OAUTH_REDIRECT_URI_INVALID: 'AUTH_OAUTH_REDIRECT_URI_INVALID',
...
export const APP_ERROR_MESSAGES: Record<AppErrorCode, string> = {
  ...
  [AppErrorCode.TRANSACTION_COMMISSION_INVALID]: '수수료는 0 이상이어야 합니다.',

  [AppErrorCode.AUTH_OAUTH_REDIRECT_URI_REQUIRED]: 'OAuth redirect URI가 필요합니다.',
  [AppErrorCode.AUTH_OAUTH_REDIRECT_URI_INVALID]: 'OAuth redirect URI가 올바르지 않습니다.',
