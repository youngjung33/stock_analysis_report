...
function interpretVix(vix: number): Pick<MacroIndicatorSnapshot, 'interpretLabel' | 'interpretDetail' | 'tone'> {
  if (vix >= 30) {
    return {
...
function interpretFx(krwPerUsd: number, change1d: number | null): Pick<MacroIndicatorSnapshot, 'interpretLabel' | 'interpretDetail' | 'tone'> {
...
function interpretYield(yieldPct: number, change1d: number | null, name: string): Pick<MacroIndicatorSnapshot, 'interpretLabel' | 'interpretDetail' | 'tone'> {
